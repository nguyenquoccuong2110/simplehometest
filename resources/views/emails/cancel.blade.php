		...
		<div style="width: 924px; height: 610px; background: url('URLemail.png') repeat-x;margin: auto;">
			<div style="width: 746px; margin-top:18px;float: left;margin-left: 88px">
				<div style="width: 100%; height: 138px; float: left;">
					<div style="width: 271px; height: 280px;margin-top: 8px;margin-left: 28px;background: url('http://tinhdauthanhtoan.com/public/upload/banner/logo.png') no-repeat"></div>
				</div>
				...
				<div style="width: 100%;float: left;background: #fff;">
					...
					<div style="width: 100%;float: left;">
						...
						<table style="width: 51%;float: left;height: 100%;padding-left: 20px;border-right: 1px solid #DDD;">
						...
						<table style="width: 96%;margin-left: 10px;border: 1px solid #DDD; border-spacing: 0;">
							...
							<tr style="vertical-align: inherit;text-align: center;">   
								...
								<td style="padding: 5px;">
									<img width="30%" height="100%" style="float: left;" src="http://{{$_SERVER['SERVER_NAME']}}/public/upload/product/small/{{$p['picture']}}" />
									<span style="float: left;width: 70%;height: 100%;font: bold 10pt Tahoma;color: #6c6a6a;">
										{{$p['name']}}
									</span>
								</td>
								<td style="font: normal 12pt Tahoma;color: red;">{{App\MrData::toPrice($order_product['price'])}}</td>
								<td>{{$order_product['limited']}}</td>
							
								<td style="font: normal 12pt Tahoma;color: red;">
										{{App\MrData::toPrice($order_product['price']*$order_product['limited'])}}
