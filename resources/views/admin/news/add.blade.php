 ...
 @section('content')
        ...
        <div class="container-fluid">
          @if(count($errors)>0)
                    ...
                    @endif          
           {!! Form::open(['method'=>'post','files'=>true,'url'=>DOMAIN_URL.'/admin/news/add']) !!}
 ...
 {!! Form::radio('status','2', (($data['status']=='2')? true : false) ) !!} Disable 
                                              ...
                                              <div class="col-sm-10">
                                                ...
                                                <div class="form-group">
                                                  ...
                                                  <textarea  id='contents'  name="content"  name="textarea-input" rows="9" class="form-control {{ (!empty($error['contents'])) ? 'is-invalid':'' }}" placeholder="Content..">{{@$data['contents']}}</textarea>
                                                   <span style="color:red">*</span>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-10">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control"  name="seo_title" id="name" placeholder="Input.. " value="{{@$data['seo_title']}}">
                                                        </div>
                                                        <div class="form-group">
                                                            <label for="name"> Description  </label>
                                                            <input type="text" class="form-control"  name="seo_description" id="name" placeholder="Input.. " value="{{@$data['seo_description']}}">
                                                        </div>
                                                        <div class="form-group">
                                                            <label for="name"> Keyword </label>
                                                            <input type="text" class="form-control"  name="seo_keyword" id="name" placeholder="Input.. " value="{{@$data['seo_keyword']}}">
                                                        </div>
