@extends("admin.admin")
 @section('content')
            ...
            <ol class="breadcrumb">
                <li class="breadcrumb-item"> Home  </li>
                 <li class="breadcrumb-item"><a href="/admin/product/lists"> Products list </a>
                </li>
        ...
        <div class="container-fluid">
           ...
           {!! Form::open(['method'=>'post','files'=>true,'url'=>DOMAIN_URL.'/admin/product/edit?id='.$data['id'] ]) !!}
 ...
 {!! Form::textarea('content',@$data['content'],['class'=>"form-control ",'id'=>'content']) !!}
                             ...
                             <div class="col-sm-12">
                                        <div class="card">
                                            <div class="card-header">
                                                <strong>Product Pricture   </strong>
                                                <small>Form</small>
                                            </div>
                                            <div class="card-body">
                                                <div class="row">
    ...
    {!! Form::file('picture',['class'=>'load_picture form-control','accept'=>'image/*','id'=>'picture_name']) !!}
                                                        <div class="detail_picture">
                                                                <img src='/public/upload/product/small/{{$data["picture"]}}' />
